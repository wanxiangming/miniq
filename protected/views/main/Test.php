    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal">
        <fieldset>
          ...
          <div class="row correction-row-css form-inline" style="margin-top:20px">
            <label class="control-label col-xs-2" for="input01">事务内容</label>
            <textarea  id="backlog_add_modal_content_textarea" type="text" class=""  style="width:260;overflow-y:visible;resize:none;font-size:15px;" rows="7" cols="54" ></textarea>
          </div>
      ...
      <form class="form-horizontal">
        <fieldset>
          ...
          <div class="row correction-row-css form-inline" style="margin-top:20px">
            ...
            <input  id="set_mianQuest_modal_input" type="text" class="col-xs-10 form-control" placeholder="10字以内"  style="width:260;overflow-y:visible;resize:none;font-size:15px;"></input>
          </div>
